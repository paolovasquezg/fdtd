...
/* Macros for arrays that store the previous values of the fields.
 * Three arguments:
 *   first:  spatial displacement from the boundary
 *   second: displacement back in time
 *   third:  distance from bottom (EzLeft/EzRight) or left (EzTop/EzBottom) */
