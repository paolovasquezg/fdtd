/* Program 9.6 - abc3dfirst.c
   First-order ABC applied to each face of the 3D domain.
   Two tangential E-field components are stored per face as "old" values. */

#include "fdtd-alloc.h"
#include "fdtd-macro.h"

/* Macros to access stored "old" values at each face */
...
/* ------------------------------------------------------------------ */
/* ABC function -- called once per time step                          */
/* ------------------------------------------------------------------ */
void abc(Grid *g)
{
    int mm, nn, pp;
